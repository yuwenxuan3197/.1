...
# 	#for this model
	parser.add_argument('--hidden_dim', default=32, type=int, help='embedding size')
	parser.add_argument('--gnn_layer', default="[32,32,32]", type=str, help='gnn layers: number + dim')
...
# 	#for train
	...
	parser.add_argument('--SSL_batch', default=50, type=int, help='batch size')
	...
	parser.add_argument('--aux_beh_idx', nargs='?', default='[0,1,2]')
# 	#use less
